...
with tab3:
    ...
    if st.button("Predict Risk"):
        ...
        tot_enq, 0, 0, Unsecured_TL, Secured_TL, Unsecured_Loan_Ratio,
        CC_TL, PL_TL, Employment_Stability, Time_With_Curr_Empr,
        Age_Oldest_TL, Age_Newest_TL, 0, log_unsec_exposure, 0, enquiry_to_income]])
